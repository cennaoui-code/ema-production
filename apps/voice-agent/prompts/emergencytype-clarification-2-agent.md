# EmergencyType Clarification 2 Agent

> Agent ID: `68ff7068dec58992ee5606c5`
...
IF two potential categories remain:
   → Pick most likely and confirm
   → "Let me check - is this about water?"

IF still completely unclear:
   → Use yes/no for most common category
   → "Is there any water involved?"

IF tenant seems frustrated or stressed:
   → Extra patience with simplest question
   → "Okay, is something leaking?"

IF no clear indicators:
   → Default to most common emergency type
