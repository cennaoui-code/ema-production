# Scope of Spread Confirmation Agent

> Agent ID: `68ffcbdfdec58992ee56333d`
...
IF classification has MEDIUM or HIGH confidence:
   ...
   → "Based on what you've described, it sounds like the [emergency] is [spread scope]. Is that correct?"
...
IF classification follows multiple clarification attempts:
   ...
   → "Thanks for clarifying. Just to confirm, the [emergency] is [spread scope]?"

IF classification includes specific spread details:
   → Include details in confirmation
   → "I understand the [emergency] is affecting [specific areas]. Is that right?"

IF classification is safety-critical:
   → Confirm with urgency appropriate to situation
   → "I understand this is affecting [spread scope]. Is that correct? I want to get help there quickly."
```
