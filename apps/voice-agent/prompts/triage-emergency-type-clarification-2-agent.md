# Triage Emergency Type Clarification 2 Agent

> Agent ID: `68d1a69047dc4d584e7fa104`
...
IF two potential emergency categories identified:
   → Offer binary choice between categories
   → "Is it more like [option 1] or [option 2]?"

IF still completely unclear after previous attempts:
   → Provide simplified category list
   → Ask for direct selection
   → "Which of these best describes your emergency?"

IF tenant seems frustrated or stressed:
   → Acknowledge difficulty
   → Use yes/no questions for top categories
   → "Would you say this involves water at all?"
```
