# Emergency Type Prompt Agent Input

> Agent ID: `68ff6eefdec58992ee560565`
...
## 🚨 CONTEXT CHECK - EXECUTE BEFORE YOU SPEAK

{{#if state_triage_EmergencyType_Final}}
**STOP! Emergency type already identified: {{state_triage_EmergencyType_Final}}**
→ Your job is DONE
→ EXIT "done" immediately
→ DO NOT speak, DO NOT acknowledge, DO NOT thank tenant
→ Just EXIT silently
{{/if}}
