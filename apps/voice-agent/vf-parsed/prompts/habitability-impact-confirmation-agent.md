# Habitability Impact Confirmation Agent

> Agent ID: `68ffd3bedec58992ee5636e6`
...
IF classification has MEDIUM or HIGH confidence:
   ...
   → "Based on what you've described, it sounds like [habitability impact level]. Is that correct?"
...
IF classification follows multiple clarification attempts:
   ...
   → "Thanks for clarifying. Just to confirm, your home is currently [habitability impact level]?"

IF classification includes specific habitability details:
   → Include details in confirmation
   → "I understand you [can/cannot] [specific essential function] in your home. Is that right?"

IF classification indicates displacement needed:
   → Confirm with appropriate urgency and empathy
   → "I understand you need alternative accommodations right now. Is that correct? I want to help arrange that immediately."
```
